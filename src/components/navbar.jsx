...
export const Navbar = () => {
    ...
    return <header className={`flex  z-0 justify-between bg-white ${ !isOpen ? "sticky top-0" : ""} px-8 py-3 border-b`}>
        <div className="flex items-center  gap-3">
            ...
            <h5 className=" font-medium text-[#1A181E]">Payouts</h5>
        ...
        <div className="flex items-center rounded gap-2 px-2 py-3 text-[#808080] bg-[#F2F2F2]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
        ...
        <div className="flex items-center gap-2">
            ...
            <button className={` top-5 right-5 lg:hidden bg-white border-none text-medium font-medium  rounded-full
                ${ isOpen 
                    ? "fixed"
                    : "hidden"
                }`}
